...
def register_client(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'web/success_registration.html',
                          context=content)  # Перенаправление на страницу успешной регистрации
    else:
        form = ClientRegistrationForm()
    return render(request, 'web/register_client.html', {'form': form})
...
def get_all_clients(request):
    ...
    return render(request, 'web/all_clients.html', {'clients': clients})
...
def search_client_by_id(request, client_id):
    if request.method == 'GET':
        try:
            ...
            return render(request, 'web/client_details.html', {'client': client})
    ...
    return render(request, 'web/search_client.html')
...
def delete_client(request, client_id):
    if request.method == 'GET':
        try:
            ...
            return render(request, 'web/delete_client.html', context=content)
        except Client.DoesNotExist:
            error_message = f"Клиент с ID {client_id} не найден."
            return render(request, 'web/error.html', {'web/error_message': error_message})
    return render(request, 'web/search_client.html')
...
def get_all_products(request):
    ...
    return render(request, 'web/all_products.html', {'products': products})
...
def generate_fake_products(request):
    ...
    return render(request, 'web/fake_products.html', context=content)
...
def generate_fake_clients(request):
    ...
    return render(request, 'web/fake_clients.html', context=content)
